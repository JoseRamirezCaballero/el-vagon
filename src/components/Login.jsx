            ...
            <ul className='flex flex-row-reverse '>
              ...
              <li className='p-6 space-y-4 md:space-y-6 sm:p-8 '>
                ...
                <form onSubmit={onSubmit} className='space-y-4 md:space-y-6'>
                  <div>
                    <InputField id='numero_control-input' label='Número de usuario' maxLength={9} name='numero_control' placeholde='Ej. 19161388' value={formulario.numero_control} onChange={onChange} ncontrol />
                  </div>
                  <div>
